...
test-components:
	...
	@node --test $(WEB_DIR)/scripts/components/tests/variable-resolver.test.js $(WEB_DIR)/scripts/components/tests/request-payload.test.js $(WEB_DIR)/scripts/components/tests/request-refs.test.js $(WEB_DIR)/scripts/components/tests/graphql-schema.test.js $(WEB_DIR)/scripts/components/tests/graphql-validate.test.js $(WEB_DIR)/scripts/components/tests/graphql-introspection.test.js $(WEB_DIR)/scripts/components/tests/captures.test.js $(WEB_DIR)/scripts/components/tests/status-match.test.js $(WEB_DIR)/scripts/components/tests/captures-xml.test.js $(WEB_DIR)/scripts/components/tests/tree-model.test.js $(WEB_DIR)/scripts/components/tests/drag-drop.test.js $(WEB_DIR)/scripts/components/tests/body-filter.test.js $(WEB_DIR)/scripts/components/tests/kv-editor-shared.test.js $(WEB_DIR)/scripts/components/tests/folder-profiles.test.js $(WEB_DIR)/scripts/components/auth/tests/oauth2-fields.test.js $(WEB_DIR)/scripts/components/code-gen/tests/code-gen.test.js $(WEB_DIR)/scripts/utils/tests/theme-css.test.js
	@echo "--------------------------------"
...
test-renderer-components:
	...
	@node --test $(WEB_DIR)/scripts/tests/request-editor.test.js $(WEB_DIR)/scripts/tests/request-auth-editor.test.js $(WEB_DIR)/scripts/tests/response-viewer.test.js $(WEB_DIR)/scripts/components/tests/body-render.test.js $(WEB_DIR)/scripts/components/tests/stream-view.test.js $(WEB_DIR)/scripts/components/tests/timeline-view.test.js $(WEB_DIR)/scripts/components/tests/collections-popup.test.js $(WEB_DIR)/scripts/tests/notifications.test.js $(WEB_DIR)/scripts/tests/pill-editors.test.js $(WEB_DIR)/scripts/tests/pill-caret.test.js $(WEB_DIR)/scripts/tests/scheduled-send.test.js $(WEB_DIR)/scripts/tests/tree-view.test.js $(WEB_DIR)/scripts/tests/popup-manager.test.js $(WEB_DIR)/scripts/tests/graphql-schema-viewer.test.js $(WEB_DIR)/scripts/components/tests/variable-editor-shared.test.js $(WEB_DIR)/scripts/components/tests/vars-editor.test.js $(WEB_DIR)/scripts/components/tests/profile-picker.test.js $(WEB_DIR)/scripts/components/tests/about-dialog.test.js $(WEB_DIR)/scripts/event-bus/tests/zoom-handlers.test.js $(WEB_DIR)/scripts/event-bus/tests/timeline-handlers.test.js $(WEB_DIR)/scripts/event-bus/tests/run-folder-handlers.test.js $(WEB_DIR)/scripts/event-bus/tests/settings-handlers.test.js
	@echo "--------------------------------"
