...
test-renderer-components:
	...
	@node --test $(WEB_DIR)/scripts/tests/request-editor.test.js $(WEB_DIR)/scripts/tests/request-auth-editor.test.js $(WEB_DIR)/scripts/tests/response-viewer.test.js $(WEB_DIR)/scripts/components/tests/body-render.test.js $(WEB_DIR)/scripts/components/tests/stream-view.test.js $(WEB_DIR)/scripts/components/tests/timeline-view.test.js $(WEB_DIR)/scripts/components/tests/collections-popup.test.js $(WEB_DIR)/scripts/components/tests/headers-editor.test.js $(WEB_DIR)/scripts/tests/notifications.test.js $(WEB_DIR)/scripts/tests/pill-editors.test.js $(WEB_DIR)/scripts/tests/pill-caret.test.js $(WEB_DIR)/scripts/tests/scheduled-send.test.js $(WEB_DIR)/scripts/tests/tree-view.test.js $(WEB_DIR)/scripts/tests/popup-manager.test.js $(WEB_DIR)/scripts/tests/settings-popup.test.js $(WEB_DIR)/scripts/tests/graphql-schema-viewer.test.js $(WEB_DIR)/scripts/components/tests/variable-editor-shared.test.js $(WEB_DIR)/scripts/components/tests/vars-editor.test.js $(WEB_DIR)/scripts/components/tests/profile-picker.test.js $(WEB_DIR)/scripts/components/tests/about-dialog.test.js $(WEB_DIR)/scripts/event-bus/tests/zoom-handlers.test.js $(WEB_DIR)/scripts/event-bus/tests/timeline-handlers.test.js $(WEB_DIR)/scripts/event-bus/tests/run-folder-handlers.test.js $(WEB_DIR)/scripts/event-bus/tests/settings-handlers.test.js $(WEB_DIR)/scripts/event-bus/tests/ws-handlers.test.js $(WEB_DIR)/scripts/event-bus/tests/updater-handlers.test.js $(WEB_DIR)/scripts/event-bus/tests/menu-handlers.test.js
	@echo "--------------------------------"
