...
test-components:
	...
	@node --test $(WEB_DIR)/scripts/components/tests/variable-resolver.test.js $(WEB_DIR)/scripts/components/tests/request-payload.test.js $(WEB_DIR)/scripts/components/tests/graphql-schema.test.js $(WEB_DIR)/scripts/components/tests/graphql-validate.test.js $(WEB_DIR)/scripts/components/tests/captures.test.js $(WEB_DIR)/scripts/components/tests/status-match.test.js $(WEB_DIR)/scripts/components/tests/captures-xml.test.js $(WEB_DIR)/scripts/components/tests/tree-model.test.js $(WEB_DIR)/scripts/components/tests/body-filter.test.js $(WEB_DIR)/scripts/components/code-gen/tests/code-gen.test.js $(WEB_DIR)/scripts/utils/tests/theme-css.test.js
	@echo "--------------------------------"
...
test-renderer-components:
	...
	@node --test $(WEB_DIR)/scripts/tests/request-editor.test.js $(WEB_DIR)/scripts/tests/response-viewer.test.js $(WEB_DIR)/scripts/tests/notifications.test.js $(WEB_DIR)/scripts/tests/pill-editors.test.js $(WEB_DIR)/scripts/tests/tree-view.test.js $(WEB_DIR)/scripts/tests/popup-manager.test.js $(WEB_DIR)/scripts/components/tests/variable-editor-shared.test.js $(WEB_DIR)/scripts/event-bus/tests/zoom-handlers.test.js
	@echo "--------------------------------"
