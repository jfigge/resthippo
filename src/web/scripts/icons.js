...
const ICONS = {
  ...
  // Tray with a down arrow — "export / download to file" actions.
  download: {
    inner:
  ...
  // Tray with an up arrow — "import / upload from file" actions (the mirror of
  // `download`, so the two read as a matched export/import pair).
  upload: {
    inner:
      '<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/>' +
