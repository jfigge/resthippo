module github.com/Teradata-PE/accp-network-service/golangci-lint

go 1.26.3

// Update using "go get -tool github.com/golangci/golangci-lint/v2/cmd/golangci-lint@latest" from this directory
